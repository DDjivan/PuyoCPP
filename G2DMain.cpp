...
void G2D::initWindow(V2 WindowSize, V2 WindowStartPos, std::string name, std::string sArg0)
{
	int argcc = 3;

	// char  arg0[] = "programName";
    char* arg0 = new char[sArg0.length() + 1]; // +1 for the null terminator
    std::strcpy(arg0, sArg0.c_str()); // Copy the string content
	char  arg1[] = "arg";
...
double deltaTimeMS(std::chrono::high_resolution_clock::time_point now,
